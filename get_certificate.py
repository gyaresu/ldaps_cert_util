...
"""
LDAPS Certificate Utility for Passbolt

This tool retrieves SSL/TLS certificates from LDAPS servers for use with Passbolt.
...
Usage with Passbolt:
1. Retrieve certificates: python3 get_certificate.py --server ldap.example.com
2. Save to file: python3 get_certificate.py --server ldap.example.com --output ldap-certs.pem
