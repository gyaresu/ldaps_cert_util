...
```shell
python3 get_certificate.py --server your.ldaps.server
```
...
```shell
python3 get_certificate.py --server your.ldaps.server > ldaps_bundle.crt
```
...
```shell
python3 get_certificate.py --test --debug
```
